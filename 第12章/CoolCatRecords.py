...
top.pack(side='left')
top.date1=tkinter.tix.LabelEntry(top,label="日期:",labelside='top',)
top.date1.pack(side="left")
top.date1.entry['textvariable']=sDate
top.name1=tkinter.tix.LabelEntry(top,label="名称:",labelside='top',)
top.name1.pack(side="left")
top.name1.entry['textvariable']=sname
top.nums1=tkinter.tix.LabelEntry(top,label="数量:",labelside='top',)
top.nums1.pack(side="left")
top.nums1.entry['textvariable']=snums
top.price=tkinter.tix.LabelEntry(top,label="价格:",labelside='top',)
top.price.pack(side="left")
top.price.entry['textvariable']=sprice
top.Explain=tkinter.tix.LabelEntry(top,label="说明:",labelside='top',)
